...
export default function Navbar() {
  ...
  const menuItems = [
    { name: "Home", href: "/component", active: true },
    { name: "Menu", href: "/", },
    { name: "Blog", href: "/blog" },
    { name: "Pages", href: "/pages" },
    { name: "About", href: "/about" },
    { name: "Shop", href: "/Hero2" },
      ...
      <nav className="flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <Link href="/" className="text-white hover:text-[#FF9F0D] transition-colors">
            <Image src="/images/searchbar.png" alt="search" width={200} height={50} />
          </Link>
          <Link href="/" className="text-white hover:text-[#FF9F0D] transition-colors">
            <Image src="/images/vector.png" alt="user" width={24} height={24} />
          </Link>
          <Link href="/" className="text-white hover:text-[#FF9F0D] transition-colors">
